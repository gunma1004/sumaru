...
export async function generateMetadata({ params, searchParams }: PageProps): Promise<Metadata> {
  ...
  const seedString = locationKeyword + districtName + dongName + "sumaru-massage-mashup";
  ...
  // 🌟 '마사지' 키워드가 자연스럽게 조합된 타이틀 및 디스크립션
  const finalTitle = `${locationKeyword} ${selectedModifier} ${selectedService} 안내 · 수마루`;
