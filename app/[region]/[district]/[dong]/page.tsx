...
// 네이버 로봇 및 검색엔진이 수집하는 고유 메타데이터 생성 (20개 고유 배리에이션)
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  // 🌟 브랜드 '수마루' 적용 및 모든 타이틀에 '마사지'가 포함된 20개 고유 타이틀 리스트
  const titleVariants = [
    `${locationTitle} 마사지 제휴 안내 | 웰니스 스웨디시 & 타이마사지 - 수마루`,
    `${simpleLocation} 웰니스 마사지 추천 코스 및 프로그램 정보 · 수마루`,
    `${locationTitle} 아로마 & 스웨디시 마사지 힐링 테라피 안내 - 수마루`,
    `${simpleLocation} 정통 타이마사지 및 릴렉스 바디케어 | 수마루`,
    `${locationTitle} 프라이빗 웰니스 힐링 마사지 제휴점 - 수마루`,
    `${simpleLocation} 전신 힐링 마사지 코스 및 정찰제 가격 안내 · 수마루`,
    `${locationTitle} 1:1 맞춤형 마사지 바디케어 & 웰니스 가이드 - 수마루`,
    `${simpleLocation} 편안한 힐링 마사지 제휴업체 정보 | 수마루`,
    `${locationTitle} 쾌적한 스웨디시 & 아로마 마사지 안내 - 수마루`,
    `${simpleLocation} 웰니스 바디 마사지 테라피 및 정찰제 코스 가이드 · 수마루`,
    `${locationTitle} 전문 테라피스트 제휴 마사지샵 리스트 - 수마루`,
    `${locationTitle} 편안한 휴식을 위한 아로마 바디케어 마사지 안내 - 수마루`,
    `${locationTitle} 감성 스웨디시 및 마사지 힐링 프로그램 요약 - 수마루`,
    `${simpleLocation} 도심 속 힐링 테라피 및 마사지 안내 - 수마루`,
    `${locationTitle} 맞춤형 바디 마사지 테라피 제휴 정보 - 수마루`,
    `${simpleLocation} 쾌적하고 조용한 마사지 샵 가이드 - 수마루`,
    `${locationTitle} 프리미엄 웰니스 케어 마사지 프로그램 안내 - 수마루`,
    `${simpleLocation} 일상 회복을 위한 바디 릴렉싱 마사지 코스 - 수마루`,
    `${locationTitle} 정통 테라피 및 스웨디시 마사지 제휴 가이드 - 수마루`,
    `${locationTitle} 신뢰할 수 있는 웰니스 마사지 정보 - 수마루`
  ];

  // 🌟 브랜드 '수마루' 적용 및 모든 디스크립션에 '마사지'가 포함된 20개 고유 리스트
