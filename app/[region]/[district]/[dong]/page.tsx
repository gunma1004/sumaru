...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  // 🌟 스팸 키워드를 완전히 배제한 20개의 고유 타이틀 리스트
  const titleVariants = [
    `${locationTitle} 마사지 제휴 안내 | 웰니스 스웨디시 & 타이마사지 - 위치 테라피`,
    `${simpleLocation} 웰니스 마사지 추천 코스 및 프로그램 정보 · 위치 테라피`,
    `${locationTitle} 아로마 & 스웨디시 힐링 테라피 안내 - 위치 테라피`,
    `${simpleLocation} 정통 타이마사지 및 릴렉스 바디케어 | 위치 테라피`,
    `${locationTitle} 프라이빗 웰니스 힐링 마사지 제휴점 - 위치 테라피`,
    `${simpleLocation} 전신 힐링 마사지 코스 및 정찰제 가격 안내 · 위치 테라피`,
    `${locationTitle} 1:1 맞춤형 바디케어 & 웰니스 마사지 가이드 - 위치 테라피`,
    `${simpleLocation} 편안한 힐링 마사지 제휴업체 정보 | 위치 테라피`,
    `${locationTitle} 쾌적한 스웨디시 & 아로마 웰니스 안내 - 위치 테라피`,
    `${simpleLocation} 웰니스 바디 테라피 및 정찰제 코스 가이드 · 위치 테라피`,
    `${locationTitle} 전문 테라피스트 제휴 마사지샵 리스트 - 위치 테라피`,
    `${simpleLocation} 편안한 휴식을 위한 아로마 바디케어 마사지 안내 - 위치 테라피`,
    `${locationTitle} 감성 스웨디시 및 힐링 프로그램 요약 - 위치 테라피`,
    `${simpleLocation} 도심 속 힐링 테라피 및 마사지 안내 - 위치 테라피`,
    `${locationTitle} 맞춤형 바디 테라피 제휴 정보 - 위치 테라피`,
    `${simpleLocation} 쾌적하고 조용한 마사지 샵 가이드 - 위치 테라피`,
    `${locationTitle} 프리미엄 웰니스 케어 마사지 프로그램 안내 - 위치 테라피`,
    `${simpleLocation} 일상 회복을 위한 바디 릴렉싱 코스 - 위치 테라피`,
    `${locationTitle} 정통 테라피 및 스웨디시 제휴 가이드 - 위치 테라피`,
