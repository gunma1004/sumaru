...
// 💎 '출장'과 '마사지'가 붙지 않도록 분산시킨 5개 제휴샵 데이터
...
> = {
  "1": {
    ...
    courses: [
      { name: "출장 아로디시 순환 방문 케어", time: "90분", price: "100,000원", desc: "부드러운 오일링과 마사지로 전신 순환을 돕는 힐링 아로디시 코스" },
      { name: "출장 아로디시 롱타임 방문 테라피", time: "120분", price: "130,000원", desc: "여유로운 시간 동안 마사지와 휴식을 온전히 누리는 120분 코스" },
      { name: "출장 VIP 스웨디시 방문 케어 A", time: "60분", price: "110,000원", desc: "감성적인 터치와 마사지로 굳은 긴장을 부드럽게 녹여주는 스웨디시" },
      { name: "출장 VIP 스웨디시 방문 케어 B", time: "90분", price: "130,000원", desc: "깊은 피로 회복과 안정감을 선사하는 추천 VIP 마사지 코스" },
      { name: "출장 VIP 스웨디시 풀케어 테라피", time: "120분", price: "150,000원", desc: "머리부터 발끝까지 여유롭게 이완하는 120분 전신 마사지 풀코스" },
      { name: "출장 한국인 전문 관리사 방문 케어 A", time: "60분", price: "140,000원", desc: "실력파 테라피스트의 섬세한 1:1 맞춤형 방문 바디 마사지" },
      { name: "출장 한국인 전문 관리사 방문 케어 B", time: "90분", price: "180,000원", desc: "최고의 만족감을 선사하는 프리미엄 스페셜 방문 마사지 코스" },
    ],
  ...
  "2": {
    ...
    courses: [
      { name: "출장 타이 스트레칭 방문 케어", time: "60분", price: "60,000원", desc: "전신 근육을 시원하게 늘려주어 뻐근함을 풀어주는 기본 타이 마사지" },
      { name: "출장 타이 릴렉스 방문 테라피", time: "90분", price: "80,000원", desc: "여유로운 전신 스트레칭과 마사지로 묵은 긴장을 덜어내는 추천 코스" },
      { name: "출장 타이 딥케어 방문 프로그램", time: "120분", price: "100,000원", desc: "전신 구석구석을 꼼꼼하게 이완시켜 주는 120분 집중 마사지 코스" },
      { name: "출장 아로마 순환 방문 케어", time: "60분", price: "70,000원", desc: "부드러운 에센셜 오일로 전신 순환을 촉진하는 아로마 마사지" },
      { name: "출장 아로마 힐링 방문 테라피", time: "90분", price: "90,000원", desc: "스트레스 완화와 포근한 휴식을 돕는 인기 아로마 마사지 코스" },
      { name: "출장 아로마 딥릴렉스 방문 케어", time: "120분", price: "110,000원", desc: "깊은 이완과 활력을 전하는 120분 프리미엄 아로마 마사지 코스" },
      { name: "출장 VIP 감성 릴렉스 방문 케어 A", time: "60분", price: "90,000원", desc: "부드러운 터치와 마사지가 결합된 시그니처 힐링 코스" },
      { name: "출장 VIP 감성 릴렉스 방문 케어 B", time: "90분", price: "110,000원", desc: "높은 고객 만족도를 자랑하는 맞춤형 방문 바디 마사지" },
      { name: "출장 VIP 감성 릴렉스 방문 케어 C", time: "120분", price: "130,000원", desc: "오래도록 지속되는 편안함과 마사지 효과를 주는 롱타임 코스" },
      { name: "출장 VIP 스페셜 콤비 방문 케어 A", time: "60분", price: "100,000원", desc: "단시간에 효과적인 컨디션 회복을 누리는 방문 스페셜 마사지" },
      { name: "출장 VIP 스페셜 콤비 방문 케어 B", time: "90분", price: "120,000원", desc: "체형 맞춤 테크닉이 적용된 고품격 힐링 방문 마사지 프로그램" },
      { name: "출장 VIP 스페셜 콤비 방문 케어 C", time: "120분", price: "140,000원", desc: "최고의 안락함을 드리는 120분 프리미엄 마사지 스페셜 코스" },
      { name: "출장 VIP 올인원 프리미엄 방문 케어", time: "150분", price: "160,000원", desc: "타이 스트레칭과 아로마 마사지, 풋케어를 모두 담은 종합 패키지" },
      { name: "출장 한국 관리사 방문 스웨디시 A", time: "60분", price: "140,000원", desc: "한국인 전문 테라피스트의 디테일하고 정갈한 마사지 힐링 케어" },
      { name: "출장 한국 관리사 방문 스웨디시 B", time: "90분", price: "180,000원", desc: "궁극의 편안함을 선사하는 최고급 감성 스웨디시 마사지 풀코스" },
    ],
  ...
  "3": {
    ...
    courses: [
      { name: "출장 타이 베이직 방문 케어", time: "60분", price: "60,000원", desc: "뻐근한 몸을 시원하게 스트레칭해 주는 기본 건식 방문 마사지" },
      { name: "출장 타이 스탠다드 방문 테라피", time: "90분", price: "80,000원", desc: "근육 결을 따라 전신을 편안하게 이완시키는 타이 마사지 추천 코스" },
      { name: "출장 타이 풀타임 방문 프로그램", time: "120분", price: "100,000원", desc: "답답했던 피로 부위를 꼼꼼하게 정돈하는 120분 전신 마사지 코스" },
      { name: "출장 아로마 소프트 방문 케어", time: "60분", price: "70,000원", desc: "부드럽고 에센셜 오일 마사지와 정성스러운 손길의 순환 케어" },
      { name: "출장 아로마 마일드 방문 테라피", time: "90분", price: "90,000원", desc: "스트레스 해소와 전신 밸런스를 돕는 인기 아로마 마사지 코스" },
      { name: "출장 아로마 프리미엄 방문 케어", time: "120분", price: "110,000원", desc: "깊은 이완과 편안한 숙면을 유도하는 풍성한 아로마 마사지 테라피" },
      { name: "출장 VIP 감성 방문 마사지 (60분)", time: "60분", price: "90,000원", desc: "섬세한 감성 터치와 마사지가 더해져 심신을 녹여주는 코스" },
      { name: "출장 VIP 감성 방문 마사지 (90분)", time: "90분", price: "110,000원", desc: "만족도 높은 시그니처 감성 힐링 방문 마사지 프로그램" },
      { name: "출장 VIP 감성 방문 마사지 (120분)", time: "120분", price: "130,000원", desc: "온전한 휴식과 안정을 채워주는 120분 롱타임 방문 마사지 코스" },
      { name: "출장 VIP 맞춤 방문 마사지 (60분)", time: "60분", price: "100,000원", desc: "집중적인 피로 부위를 효율적으로 풀어주는 방문 스페셜 코스" },
      { name: "출장 VIP 맞춤 방문 마사지 (90분)", time: "90분", price: "120,000원", desc: "체계적인 압 조절과 이완 기법의 고품격 방문 마사지 테라피" },
      { name: "출장 VIP 맞춤 방문 마사지 (120분)", time: "120분", price: "140,000원", desc: "차별화된 안락함을 선사하는 최고급 맞춤 방문 마사지 케어" },
      { name: "출장 VIP 하이브리드 종합 방문 케어", time: "150분", price: "160,000원", desc: "타이 스트레칭, 아로마 마사지, 풋케어의 올인원 패키지" },
      { name: "출장 한국인 전문 힐러 방문 마사지 (60분)", time: "60분", price: "140,000원", desc: "실력파 한국인 관리사의 1:1 품격 있는 감성 스웨디시 마사지" },
      { name: "출장 한국인 전문 힐러 방문 마사지 (90분)", time: "90분", price: "180,000원", desc: "극상의 만족감을 약속드리는 하이엔드 프리미엄 방문 마사지 코스" },
    ],
  ...
  "4": {
    ...
    courses: [
      { name: "출장 건식 베이직 방문 케어", time: "60분", price: "60,000원", desc: "목, 어깨, 등의 뭉친 피로를 가볍게 풀어주는 건식 방문 마사지" },
      { name: "출장 건식 스탠다드 방문 테라피", time: "90분", price: "80,000원", desc: "전신 근육을 차분하게 이완시키는 여유로운 건식 힐링 마사지" },
      { name: "출장 건식 풀케어 방문 프로그램", time: "120분", price: "100,000원", desc: "누적된 피로를 완벽하게 날려주는 120분 집중 건식 마사지" },
      { name: "출장 오일 베이직 방문 케어", time: "60분", price: "70,000원", desc: "천연 아로마 오일 마사지로 피부 보습과 순환을 돕는 프로그램" },
      { name: "출장 오일 스탠다드 방문 테라피", time: "90분", price: "80,000원", desc: "지친 감각을 부드럽게 달래주는 아로마 마사지 힐링 코스" },
      { name: "출장 오일 풀케어 방문 프로그램", time: "120분", price: "100,000원", desc: "전신을 풍성한 에센셜 오일 마사지로 채워주는 프리미엄 코스" },
      { name: "출장 스웨디시 마일드 방문 케어", time: "60분", price: "80,000원", desc: "부드럽고 감미로운 터치의 소프트 스웨디시 방문 마사지 힐링" },
      { name: "출장 스웨디시 포커스 방문 테라피", time: "90분", price: "100,000원", desc: "깊은 안정감과 이완을 선사하는 프리미엄 스웨디시 마사지" },
      { name: "출장 스웨디시 스페셜 방문 프로그램", time: "120분", price: "120,000원", desc: "여유롭고 섬세하게 진행되는 120분 감성 마사지 힐링" },
      { name: "출장 VIP 맞춤형 스페셜 방문 케어 (60분)", time: "60분", price: "100,000원", desc: "차별화된 만족감을 선사하는 VIP 스페셜 방문 바디케어" },
      { name: "출장 VIP 맞춤형 스페셜 방문 케어 (90분)", time: "90분", price: "120,000원", desc: "고객 컨디션에 따른 최상급 테라피스트의 방문 집중 마사지" },
      { name: "출장 VIP 맞춤형 스페셜 방문 케어 (120분)", time: "120분", price: "150,000원", desc: "온전한 휴식과 안정을 누리는 120분 VIP 마사지 마스터피스" },
      { name: "출장 한국인 관리사 전담 방문 케어 (60분)", time: "60분", price: "150,000원", desc: "전문 한국인 관리사의 디테일한 1:1 맞춤 방문 마사지" },
      { name: "출장 한국인 관리사 전담 방문 케어 (90분)", time: "90분", price: "180,000원", desc: "최고의 만족도를 드리는 프리미엄 한국인 전담 방문 마사지 코스" },
    ],
  ...
  "5": {
    ...
    courses: [
      { name: "출장 골든 스웨디시 방문 케어 (60분)", time: "60분", price: "140,000원", desc: "부드럽고 감성적인 터치로 심신을 녹여주는 스웨디시 마사지 코스" },
      { name: "출장 골든 스웨디시 방문 케어 (90분)", time: "90분", price: "190,000원", desc: "깊은 안정감과 활력을 불어넣는 90분 명품 스웨디시 마사지" },
      { name: "출장 프리미엄 릴렉스 방문 케어 (60분)", time: "60분", price: "110,000원", desc: "굳은 몸을 효율적으로 이완시켜 주는 실속형 방문 바디 마사지" },
      { name: "출장 프리미엄 릴렉스 방문 케어 (90분)", time: "90분", price: "130,000원", desc: "여유로운 템포로 전신 밸런스를 되찾아주는 방문 힐링 마사지" },
      { name: "출장 프리미엄 릴렉스 방문 케어 (120분)", time: "120분", price: "150,000원", desc: "모든 피로를 개운하게 해소하는 120분 전신 방문 마사지 풀코스" },
    ],
    features: ["100% 후불제 안심 예약", "수도권 전지역 빠른 도착", "전문 힐러진 상시 대기"],
  },
};

// 🎯 '출장'과 '마사지'가 붙지 않도록 분산된 30개 타이틀 적용
